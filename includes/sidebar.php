    <div class="sidebar-menu" >
                    <header class="logo1">
                      ...
                      <span style="color:#000; font-size:100%; font-weight:bold">Jade Marina</span>
                        <a href="#" class="sidebar-icon"><span class="fa fa-bars"></span> </a> 
                    </header>
                        <div style="border-top:1px;"></div>
                           <div class="menu">
                                    <ul id="menu">
                                     ...
                                     <li id="menu-academico" ><a href="#"><i class="lnr lnr-pencil"></i> <span>New Food</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            <li id="menu-academico-avaliacoes" ><a href="add-food.php">Add Food</a></li>
                                            <li id="menu-academico-boletim" ><a href="manage-food.php">Manage Food</a></li>

                                          </ul>
                                     </li>
                                       <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>New Food Type</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            <li id="menu-academico-avaliacoes" ><a href="add-foodtype.php">Add Food Type</a></li>
                                            <li id="menu-academico-boletim" ><a href="manage-foodtype.php">Manage Food Type</a></li>
